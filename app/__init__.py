...
def _run_migrations(db):
    ...
    migrations = [
        ...
        "ALTER TABLE products ADD COLUMN IF NOT EXISTS online_active BOOLEAN DEFAULT TRUE",
        ...
        # Disponibilidade no Cardápio da Loja (lanchonete)
        "ALTER TABLE products ADD COLUMN IF NOT EXISTS disponivel BOOLEAN DEFAULT TRUE",
...
def create_app():
    ...
    def security_headers(response):
        ...
        # geolocation=(self) permite que a loja use GPS do cliente
